 ...
 * - `ground` : trait de sol et fourche de repos au bout du bras.
 */
...
export function Barrier({ raised = false, lift = false, ground = true, className }: BarrierProps) {
  return (
    <svg
    ...
    >
      ...
      <rect className={styles.slot} x="21" y="72" width="12" height="2" rx="1" />
      <circle className={styles.lampOff} cx="27" cy="38" r="3.5" />
      <circle className={styles.lampStop} cx="27" cy="38" r="3.5" />
      <circle className={styles.lampGo} cx="27" cy="38" r="3.5" />
